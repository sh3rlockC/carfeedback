...
assertIncludes("apps/web/app/tasks/[taskId]/page.tsx", "/api/tasks/${taskId}/result");
assertIncludes("apps/web/app/tasks/[taskId]/page.tsx", "下载全部结果包");
assertIncludes("apps/web/app/tasks/[taskId]/page.tsx", "产物明细");
assertNotIncludes("apps/web/app/tasks/[taskId]/page.tsx", "当前详情未返回可展示产物");
